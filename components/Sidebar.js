...
function Sidebar() {
  ...
  return (
    <div className="space-y-2 min-w-max max-w-lg">
      ...
      <div className="bg-white dark:bg-[#1D2226] rounded-lg overflow-hidden relative flex flex-col items-center text-center border border-gray-300 dark:border-none">
        ...
        <div className="hidden md:inline text-left dark:text-white/75 text-sm">
          ...
          <div className="sidebarButton">
            <h4 className="leading-4 text-xs">Acces exclusive</h4>
      ...
      {/**Bottom **/}
      <div className="hidden md:flex bg-white dark:bg-[#1D2226] texy-black/70 dark:text-white/75 rounded-lg overflow-hidden flex-col space-y-2 pt-2.5 sticky top-20 border border-gray-300 dark:border-none">
